<template>
  <div>
    <div class="add-task">
      <input type="text" placeholder="+ Add Task" @focus="focusText" />
    </div>
    <div class="body">
      <div class="edit" v-if="newTodo">
        <div class="info-head">
          <div class="type">
            <input type="checkbox" />
            <p @click="editTile = !editTile" v-if="editTile">
              Type Something Here...
            </p>
            <input
              type="text"
        ...
        <div class="info-body">
          <div class="data">
            ...
            <div class="data-input">
              ...
              />
              <input type="text" placeholder="hh:mm" v-model="taskData.time" />
            </div>
          </div>
          <div class="data">
            <div class="data-title">
        ...
        <div class="info-footer">
          ...
          <button class="plus" @click="addTask">
    ...
    <div v-for="(item, index) in taskArray">
      <div class="task" v-if="!item.editTask">
        <div
          class="task-info"
          ...
          <div class="type">
            ...
            <div class="task-feature">
              <font-awesome-icon
                ...
                v-if="item.date"
              />
              <font-awesome-icon icon="fa-regular fa-file" v-if="item.file" />
              <font-awesome-icon
    ...
    <p class="task-left">剩餘任務 {{ taskLeftCount }} 個</p>
  </div>
</template>
<script>
export default {
